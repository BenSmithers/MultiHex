...
class editor_gui_window(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5 = QtWidgets.QLabel(self.Kingdoms)
        self.label_5.setObjectName("label_5")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_5)
        self.label_6 = QtWidgets.QLabel(self.Kingdoms)
        ...
        self.label_7 = QtWidgets.QLabel(self.Kingdoms)
        self.label_7.setObjectName("label_7")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_7)
        self.label_8 = QtWidgets.QLabel(self.Kingdoms)
        self.label_8.setFrameShape(QtWidgets.QFrame.Box)
        self.label_8.setFrameShadow(QtWidgets.QFrame.Raised)
        self.label_8.setText("")
        self.label_8.setObjectName("label_8")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.label_8)
        self.label_9 = QtWidgets.QLabel(self.Kingdoms)
        self.label_9.setObjectName("label_9")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_9)
        self.label_10 = QtWidgets.QLabel(self.Kingdoms)
        self.label_10.setFrameShape(QtWidgets.QFrame.Box)
        self.label_10.setFrameShadow(QtWidgets.QFrame.Raised)
        self.label_10.setText("")
        self.label_10.setObjectName("label_10")
        self.formLayout_5.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.label_10)
        self.label_11 = QtWidgets.QLabel(self.Kingdoms)
        self.label_11.setObjectName("label_11")
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.label_11)
        self.listWidget = QtWidgets.QListWidget(self.Kingdoms)
        self.listWidget.setObjectName("listWidget")
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.listWidget)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.pushButton_3 = QtWidgets.QPushButton(self.Kingdoms)
        self.pushButton_3.setObjectName("pushButton_3")
        self.horizontalLayout_3.addWidget(self.pushButton_3)
        self.pushButton_2 = QtWidgets.QPushButton(self.Kingdoms)
        self.pushButton_2.setObjectName("pushButton_2")
        self.horizontalLayout_3.addWidget(self.pushButton_2)
        self.formLayout_5.setLayout(6, QtWidgets.QFormLayout.SpanningRole, self.horizontalLayout_3)
        self.pushButton_4 = QtWidgets.QPushButton(self.Kingdoms)
        self.pushButton_4.setObjectName("pushButton_4")
        self.formLayout_5.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.pushButton_4)
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout_5.setItem(7, QtWidgets.QFormLayout.LabelRole, spacerItem6)
        self.label_14 = QtWidgets.QLabel(self.Kingdoms)
        self.label_14.setObjectName("label_14")
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_14)
        self.label_15 = QtWidgets.QLabel(self.Kingdoms)
        self.label_15.setFrameShape(QtWidgets.QFrame.Box)
        self.label_15.setFrameShadow(QtWidgets.QFrame.Raised)
        self.label_15.setText("")
        self.label_15.setObjectName("label_15")
        self.formLayout_5.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.label_15)
...
"Contained Cities:"))
        ...
        self.label_7.setText(_translate("MainWindow", "Subjects: "))
        self.label_9.setText(_translate("MainWindow", "Wealth: "))
        self.label_11.setText(_translate("MainWindow", "\n"
"Counties:"))
        self.pushButton_3.setText(_translate("MainWindow", "Add New"))
        self.pushButton_2.setText(_translate("MainWindow", "Remove"))
        self.pushButton_4.setText(_translate("MainWindow", "Dissolve"))
        self.label_14.setText(_translate("MainWindow", "GDG: "))
