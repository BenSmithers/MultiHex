...
class editor_gui_window(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.label_11)
        self.listWidget = QtWidgets.QListView(self.Kingdoms)
        self.listWidget.setObjectName("listWidget")
        self.formLayout_5.setWidget(6, QtWidgets.QFormLayout.SpanningRole, self.listWidget)
        ...
        self.formLayout_5.setLayout(7, QtWidgets.QFormLayout.SpanningRole, self.horizontalLayout_3)
        self.king_dissolve_but = QtWidgets.QPushButton(self.Kingdoms)
        self.king_dissolve_but.setObjectName("king_dissolve_but")
        self.formLayout_5.setWidget(10, QtWidgets.QFormLayout.SpanningRole, self.king_dissolve_but)
        spacerItem6 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.formLayout_5.setItem(9, QtWidgets.QFormLayout.LabelRole, spacerItem6)
        ...
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.king_apply)
        self.king_state = QtWidgets.QLabel()
        self.king_state.setObjectName("king_state")
        self.formLayout_5.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.king_state)
...
"Counties:"))
        ...
        self.king_apply.setText(_translate("MainWindow","Apply Name"))
